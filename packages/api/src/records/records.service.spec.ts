...
describe("RecordsService", () => {
  ...
  describe("findById", () => {
    ...
    it("should throw NotFoundException if not found", async () => {
      ...
      await expect(service.findById(tenantId, recordId)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("update", () => {
    ...
    it("should throw NotFoundException if record not found", async () => {
      mockRepo.findOne.mockResolvedValue(null);
      await expect(service.update(tenantId, recordId, {})).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("sign", () => {
    it("should sign the record", async () => {
      ...
      await service.sign(tenantId, recordId, userId);
