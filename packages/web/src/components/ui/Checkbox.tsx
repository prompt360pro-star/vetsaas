    ...
    return (
        <label className={`flex items-start gap-3 group ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${className}`}>
            <div className="relative flex items-center h-5 mt-0.5">
                ...
                <motion.div
                    className={`
                        w-5 h-5 rounded-md border transition-colors flex items-center justify-center peer-focus-visible:ring-2 peer-focus-visible:ring-primary-500 peer-focus-visible:ring-offset-2 dark:peer-focus-visible:ring-offset-surface-900
